...
public class Main {
	...
	public static void main(String[] args) {
		...
		Cancion cancion7 = new Cancion("El ni�o de Bel�n", 104);
		Cancion cancion8 = new Cancion("A Quien Ir�",105);
		...
		h2.dormir();
		System.out.println("Despert� y ahora...");
		h2.alimentarse();
		System.out.println("\n");
		System.out.println("\u001B[36mMi lista de Canciones Favoritas es: \u001B[0m");
		h2.listarCanciones();
		h2.eliminarCancion("A Quien Ir�");
		System.out.println("\n");
		h2.listarCanciones();
		System.out.println("------------------------------------");
		System.out.println("�Qui�n de los dos humanos es mayor?");
